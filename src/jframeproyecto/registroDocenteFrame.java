 ...
 */
public class registroDocenteFrame extends javax.swing.JFrame {

    /**
     * Creates new form registroDocente
     */
    public registroDocenteFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 10, 331, 50));

        dniDocente.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.add(dniDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, 150, -1));
        ...
        jPanel1.add(claveDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 150, -1));
        ...
        jPanel1.add(nombreDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 150, -1));

        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("APELLIDOS: ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, -1, -1));

        bt_registrar.setBackground(new java.awt.Color(255, 102, 102));
        ...
        jPanel1.add(bt_registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 100, 40));

        apellidosDocente.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.add(apellidosDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 150, -1));

        aulaDocente.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.add(aulaDocente, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 210, 150, -1));
        ...
        jPanel1.add(bt_volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 300, 100, 40));
        ...
        jPanel1.add(bt_masculino, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, -1, 30));
        ...
        jPanel1.add(bt_femenino, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, -1, 30));
        ...
        if (okey) {
            ...
            if (dni.length() == 8 && clave.length() == 4) {
                if (listaDocentes.BuscarXDni(dni) == -1 && listaDocentes.BuscarXClave(clave) == -1) {
                    ...
                    if (listaDocentes.BuscarXDni(dni) > -1 && listaDocentes.BuscarXClave(clave) > -1) {
                        JOptionPane.showMessageDialog(null, "DNI y Clave ya existe");
                        dniDocente.setText("");
                        claveDocente.setText("");
                    }else if(listaDocentes.BuscarXDni(dni) > -1){
                        JOptionPane.showMessageDialog(null, "DNI ya existe");
                        dniDocente.setText("");
                    }else{
                        JOptionPane.showMessageDialog(null, "Clave ya existe");
                        claveDocente.setText("");
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registroDocenteFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new registroDocenteFrame().setVisible(true);
            }
        });
    }
